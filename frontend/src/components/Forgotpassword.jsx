...
function Forgotpassword() {
  ...
  const [optionrealvalue,setoptionrealvalue] = useState("")
  const [email,setemail] = useState("")

  const changing = (e)=>{
    
    setoptionrealvalue(e.target.value)
    setoptionvalue(e.target.value === "doctor" || e.target.value === "patient")
    ...
    <div className='w-full min-h-screen bg-black overflow-hidden'>
      ...
      <div className='p-5' >
          ...
          <div className='flex bg-[#e308ea] w-fit rounded-xl '>
              ...
              <Link to ="/Signin"><button class=" text-white text-[20px] font-medium font-['Lexend']  pr-4 pt-2">Home</button></Link>
      ...
      <div className='flex'>
        ...
        {!optionvalue && (<div className='space-y-10 m-40'>
              ...
              <div className='bg-[#e308ea] flex rounded-2xl '>
                <button className='font-Lexend text-white text-2xl p-4 pl-9' value="patient" onClick={changing} >
                  PATIENT
                </button>
                <div className='p-4'>
        ...
        <div className='flex flex-col m-28'>
            ...
            <div className='pt-8 pl-24'>
              <button className='bg-[#e308ea] p-2 pl-4 pr-4 rounded-lg w-fit ' onClick={submiting}>SUBMIT</button>
            </div>
          </div>
        </div>)}
      </div>
      ...
      <div className='p-6 '>
        <select className='p-4 rounded-lg shadow-lg px-7' value={optionrealvalue} onChange={changing} >
          <option value="">SELECT OPTIONS</option>
          <option value="doctor">DOCTOR</option>
          <option value="patient">PATIENT</option>
        </select>
      </div>
      {optionvalue && <div className='flex flex-col space-y-5'>
      <input type="email" className='p-4 w-80 rounded-xl font-medium' placeholder='Enter Email' value={email} onChange={(e)=>{setemail(e.target.value)}} />
      <button className='bg-mycolortwo-950 px-2 p-2 rounded-lg shadow-lg' onClick={submiting}>SUBMIT</button>
      </div>} */}
    </div>
  )
}
